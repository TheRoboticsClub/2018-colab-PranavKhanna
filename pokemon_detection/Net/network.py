...
class Detection_Network(object):
	...
	def __init__(self):
		...
		MODEL_NAME = '/home/pranav/PycharmProjects/2018-colab-PranavKhanna/pokemon_detection/Net/pokemon_training'
		# the class is called from the root dir of the project!
		
		# path to the frozen graph (inside the model).
 		PATH_TO_CKPT = MODEL_NAME + '/pokemon.pb'


		# path to the labels (id-name association).
		PATH_TO_LABELS = os.path.join(MODEL_NAME, 'pokemon.pbtxt')
		NUM_CLASSES = 1
